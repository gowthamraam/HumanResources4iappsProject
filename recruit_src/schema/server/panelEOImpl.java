...
// ---------------------------------------------------------------------
public class panelEOImpl extends OAEntityImpl {
    public static final int INTPANELID = 0;
    public static final int APPINTID = 1;
    public static final int APPID = 2;
    public static final int PERSONID = 3;
    public static final int PERSONNAME = 4;
    ...
    public static final int INTEREO = 27;
    public static final int APPLEO = 28;
    ...
    public static synchronized EntityDefImpl getDefinitionObject() {
        if (mDefinitionObject == null) {
            mDefinitionObject = 
                    (OAEntityDefImpl)EntityDefImpl.findDefObject("xxhlp.oracle.apps.xxhlp.recruit.schema.server.panelEO");
        }
        return mDefinitionObject;
    }

    /**Gets the attribute value for IntPanelId, using the alias name IntPanelId
     */
    public Number getIntPanelId() {
        return (Number)getAttributeInternal(INTPANELID);
    }

    /**Sets <code>value</code> as the attribute value for IntPanelId
     */
    public void setIntPanelId(Number value) {
        setAttributeInternal(INTPANELID, value);
    }
    ...
    /**Gets the associated entity interEOImpl
     */
    public interEOImpl getInterEO() {
        return (interEOImpl)getAttributeInternal(INTEREO);
    }

    /**Sets <code>value</code> as the associated entity interEOImpl
     */
    public void setInterEO(interEOImpl value) {
        setAttributeInternal(INTEREO, value);
    }
     ...
     */
    public static Key createPrimaryKey(Number intPanelId) {
        return new Key(new Object[]{intPanelId});
    }
}
